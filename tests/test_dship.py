...
def test_dship():
    os.system("shippy dship -i tests/dummydshipdata.txt -o tests/testdship_output.nc -a tests/dummyvariables.yaml -s Test")
    ...
    npt.assert_almost_equal((np.linspace(10,16,61)[:-1]).mean() + 273.15, out.t_air.values[-2])
